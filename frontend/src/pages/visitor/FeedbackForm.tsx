...
export default function FeedbackForm() {
  ...
  const syncAvisEnAttente = useCallback(async () => {
    ...
    try {
      ...
      // silencieux : on réessaiera au prochain retour en ligne
    }
  }, []);
        ...
        <div style={{ maxWidth: '680px', margin: '0 auto', padding: '24px 16px 48px' }}>
          ...
          <div style={STYLE_CARTE}>
            ...
            >
              ...
              <span
                style={{ fontFamily: "'Inter', sans-serif", fontSize: '13px', color: '#1B6B3A' }}
              >
          ...
          <div style={STYLE_CARTE}>
            ...
            {chargementMotifs && (
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                <span className="spinner-border spinner-border-sm" style={{ color: '#1B6B3A' }} />
          ...
          <div style={STYLE_CARTE}>
            <div style={{ marginBottom: '4px' }}>
              ...
              <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '13px', color: '#5A7262' }}>
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', gap: '4px', marginTop: '10px' }}>
                      {[1, 2, 3, 4, 5].map((index) => (
                        ...
                        >
                          <i className={valeurAffichee >= index ? 'bi bi-star-fill' : 'bi bi-star'} />
                        </button>
                      ))}
                    </div>
                  </div>
          ...
          {serviceDejaEvalue && (
            ...
            >
              ...
              <div>
                ...
                Vous avez déjà soumis un avis pour ce service aujourd'hui. Vous pouvez sélectionner
                un autre service si vous avez effectué une autre démarche.
              </div>
            </div>
          )}
